...
function toEnglish() {
    ...
    document.getElementById("desc_1").textContent="Welcome!";
    document.getElementById("desc_2").textContent="My name is Matteo, I am a university student and a software developer.";
    document.getElementById("desc_3").textContent=" like to deal with both front-end and back-end and I like to work in a team. I'm open to any programming language / framework and I learn quickly! \n";
    document.getElementById("desc_4").textContent="I adore and follow everything related to technology from hardware to software, design and fascinate me.";
    document.getElementById("desc_5").textContent="(Leave a comment";
    document.getElementById("desc_6").textContent="even anonymous";
    document.getElementById("desc_7").textContent="below!)";
    document.getElementById("collapseButton1").textContent="Show More";
    document.getElementById("collapseButton2").textContent="Hide";
    document.getElementById("form_write_comment").textContent="Write a comment!";
